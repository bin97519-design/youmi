  ...
  <Teleport to="body">
    <div v-if="userStore.loginModalOpen" class="yh-login-backdrop">
      <section class="yh-login-modal" role="dialog" aria-modal="true" aria-label="登录">
        <button class="yh-login-close" type="button" aria-label="关闭登录框" @click="userStore.closeLogin()">×</button>
        ...
        <form class="yh-login-right" @submit.prevent="submitLogin">
          ...
          <label>
            <span>账号</span>
            <input v-model.trim="form.account" type="text" autocomplete="username" placeholder="手机号 / 登录账号" />
          </label>

...
@Component
@ConfigurationProperties(prefix = "youmi.xfyun")
public class XfyunVisionProperties {
  private String baseUrl = "https://maas-coding-api.cn-huabei-1.xf-yun.com/v2";
  private String chatPath = "/chat/completions";
  private String apiKey = "";
  private String model = "xopqwen36v35b";
